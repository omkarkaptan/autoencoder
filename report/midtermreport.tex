...
% in the abstract
\begin{abstract}
This report summarizes the implementation of an Autoencoder. A summary of the work done - namely the current implementation progress, challenges, future work, time line and references.
\end{abstract}
...
Neural net design and data structures, feed forward algorithm.
